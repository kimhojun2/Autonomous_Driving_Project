...
class SCANCluster {
  public:
    ...
    void callback(const sensor_msgs::PointCloud2ConstPtr &input) {
        ...
        pass_z.setFilterLimits(-3, 2); // 위를 자른다
        ...
        seg.setModelType(pcl::SACMODEL_PARALLEL_PLANE); // 경사
        // seg.setModelType(pcl::SACMODEL_PLANE); // 평면
