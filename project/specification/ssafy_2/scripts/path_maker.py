...
class pathMaker :    
    def __init__(self, pkg_name = 'ssafy_2', path_name = 'path'):
        ...
        full_path = pkg_path + '/' + path_name + '/ssafy_test_path.txt'
        self.f = self.f = open(full_path, 'w')
    ...
    def path_make(self):
        ...
        distance = sqrt((self.x - self.prev_x)**2 + (self.y - self.prev_y)**2)
