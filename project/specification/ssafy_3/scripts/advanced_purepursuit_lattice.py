...
class pure_pursuit :
    def __init__(self):
        ...
        rospy.Subscriber(object_topic_name,Path, self.path_callback)

        # Firebase Admin SDK 초기화
        if not firebase_admin._apps:
            self.cred = firebase_admin.credentials.Certificate("/home/morai/catkin_ws/src/ssafy_3/key/ifind-firebase-adminsdk.json")
